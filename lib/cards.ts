...
export const CARD_DEFS: CardDef[] = [
  ...
  { id: "dodge", it: "Schivata", name: "Dodge", kind: "brown",
    ...
    countsAs: "missed",
    drawOnUse: 1,
    effect: "Tính như một lá Missed!, rồi rút 1 lá.",
    notes: ["Rút SAU khi đã tính là Missed!."] },
  ...
  { id: "springfield", it: "Springfield", name: "Springfield", kind: "brown",
    ...
    target: { shoots: true },
    notes: ["Rule 5: không tiêu hạn mức Bang!/lượt.", "Mọi khoảng cách. Barrel và Missed! vẫn chống được."] },
