...
// Bảng màu áo sống ở lib/seat-colors.ts để màn home dùng được mà không kéo three.js
// theo. Re-export ở đây vì Players.tsx, test và script đo vẫn lấy từ geometry.
export { AVATAR_COLORS } from "@/lib/seat-colors";
